import { j as jsxRuntimeExports, s as House, O as ArrowRight, z as Mail, P as Phone, y as Clock, D as MapPin } from "./vendor-react-98xxEzFV.js";
import { L as Link } from "./vendor-tanstack-DkD25YnA.js";
import { S as SiteShell, C as Container } from "./router-DvCKRw9U.js";
const policyLinks = [
...
function PolicyLayout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SiteShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden bg-[#f7f3ed] text-[#5b3a29]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative px-0 pb-10 pt-10 md:pb-14 md:pt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { className: "mx-auto max-w-6xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "nav",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#c89b63]", children: "/" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#5b3a29]", children: title })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[0.68rem] uppercase tracking-[0.34em] text-[#c89b63]", children: eyebrow }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-4 font-display text-4xl leading-tight text-[#1e1b18] sm:text-5xl md:text-6xl", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 max-w-2xl text-base leading-8 text-[#6f4d38] md:text-lg", children: description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-7 inline-flex border border-[#c89b63]/30 bg-[#fffaf4]/76 px-4 py-2 text-[0.66rem] uppercase tracking-[0.24em] text-[#8b5f3d] shadow-soft", children: [
          "Last updated: ",
          lastUpdated2
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative pb-16 md:pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { className: "mx-auto max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 lg:grid-cols-[minmax(0,1fr)_17rem]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("article", { className: "space-y-5", "aria-label": `${title} sections`, children: sections.map((section, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex items-start gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 flex h-8 w-8 flex-none items-center justify-center border border-[#c89b63]/30 bg-[#f7f3ed] text-xs font-medium text-[#8b5f3d] transition group-hover:border-[#c89b63]/60", children: String(index + 1).padStart(2, "0") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl leading-snug text-[#1e1b18] md:text-3xl", children: section.title })
            ] }),
            section.content?.map((paragraph) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-7 text-[#6f4d38] md:text-base", children: paragraph }, paragraph)),
            section.items?.length ? /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-4 space-y-3 text-sm leading-7 text-[#6f4d38] md:text-base", children: section.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-3 h-1.5 w-1.5 flex-none rounded-full bg-[#c89b63]" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "self-start lg:sticky lg:top-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-[#5b3a29]/10 bg-[#fffaf4]/84 p-5 shadow-soft backdrop-blur", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[0.64rem] uppercase tracking-[0.3em] text-[#c89b63]", children: "Company Policies" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 space-y-2", children: policyLinks.map((link) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              className: `group flex items-center justify-between border-b border-[#5b3a29]/10 py-3 text-sm transition last:border-b-0 ${isCurrent ? "text-[#c89b63]" : "text-[#6f4d38] hover:text-[#c89b63]"}`,
              children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative border-y border-[#c89b63]/18 bg-[#1e1b18] py-12 text-[#fffaf4] md:py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { className: "mx-auto max-w-6xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-8 md:grid-cols-[1fr_1.35fr] md:items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[0.68rem] uppercase tracking-[0.34em] text-[#e3c69e]", children: "Contact Support" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-3 font-display text-3xl leading-tight md:text-4xl", children: "Need help with a policy or order?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-lg text-sm leading-7 text-[#efe7dc]/78 md:text-base", children: "Our support team can help with order IDs, damaged delivery checks, refunds, returns, account requests, and payment confirmation queries." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 xl:grid-cols-4", children: supportLinks.map(({ label, value, href, Icon }) => {
        const content = /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-10 w-10 items-center justify-center border border-[#e3c69e]/25 text-[#e3c69e]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-4 block text-[0.62rem] uppercase tracking-[0.26em] text-[#e3c69e]", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-2 block break-words text-sm leading-6 text-[#fffaf4]", children: value })
        ] });
        if (href) {
...
const policies = {
  shipping: {
    ...
    description: "Shipping timelines, dispatch handling, tracking support, and delivery expectations for orders placed with Purefumes Hyderabad.",
    lastUpdated,
    sections: [
      {
  ...
  privacy: {
    ...
    description: "How Purefumes Hyderabad collects, uses, protects, and shares customer information for a secure fragrance shopping experience.",
    lastUpdated,
    sections: [
      {
  ...
  terms: {
    ...
    description: "The terms that govern browsing, ordering, payments, delivery, product use, and customer responsibilities on Purefumes Hyderabad.",
    lastUpdated,
    sections: [
      {
  ...
  refund: {
    ...
    description: "Refund timelines, payment reversals, cancellation windows, and verification rules for orders placed with Purefumes Hyderabad.",
    lastUpdated,
    sections: [
      {
  ...
  return: {
    ...
    description: "Return eligibility, replacement handling, cancellation rules, inspection requirements, and support details for Purefumes Hyderabad customers.",
    lastUpdated,
    sections: [
      {
