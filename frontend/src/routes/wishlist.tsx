...
function WishlistPage() {
  const { wishlist, wishlistCount, removeFromWishlist, clearWishlist, isWishlistPending } = useApp();
              ...
              {wishlist.map((product) => (
                <div key={product.id} className="min-w-0">
                  ...
                  <button
                    ...
                    className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-xs uppercase tracking-[0.2em] text-red-700 transition hover:bg-red-100 disabled:pointer-events-none disabled:opacity-60"
                  >
