          ...
          {cart.length === 0 ? (
            ...
            <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_22rem]">
              <div className="space-y-4">
                {cart.map((item) => {
                  ...
                  <article
                    ...
                    role="button"
                    tabIndex={0}
                    onClick={() => navigateToProduct(item.product.id || item.product._id)}
                    onKeyDown={(event) => {
                  ...
                  >
                    ...
                    <OptimizedImage
                      ...
                      height={160}
                      sizes="6rem"
                      wrapperClassName="product-fit-frame aspect-square w-full rounded-lg sm:w-24"
              ...
              <aside className="h-fit rounded-lg border border-border bg-card p-5 shadow-soft sm:p-6 lg:sticky lg:top-28">
                ...
                <Button onClick={proceedToCheckout} className="mt-6 w-full" disabled={!cart.length}>
                  Proceed to Checkout
                </Button>
              </aside>
            </div>
